  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div className="col-span-1 md:col-span-1">
        <h3 className="text-2xl font-bold text-white mb-4">PulseCore Fitness Studio</h3>
        <p className="text-sm text-gray-400">
          Transform your body, elevate your mind, and achieve your fitness goals with us.
        </p>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-2">
          <li><a href="/personal-training" className="hover:text-white transition-colors">Personal Training</a></li>
          <li><a href="/group-classes" className="hover:text-white transition-colors">Group Classes</a></li>
          <li><a href="/nutrition" className="hover:text-white transition-colors">Nutrition Coaching</a></li>
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm">
          ...
          <li className="pt-2"><a href="tel:+15551234567" className="hover:text-white transition-colors">(555) 123-4567</a></li>
          <li><a href="mailto:info@pulsecorefitness.com" className="hover:text-white transition-colors">info@pulsecorefitness.com</a></li>
        </ul>
    ...
    <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
      <p className="text-sm text-gray-400">
        &copy; {new Date().getFullYear()} PulseCore Fitness Studio. All rights reserved.
      </p>
